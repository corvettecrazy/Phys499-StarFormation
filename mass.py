...
t=Table.read('BGPS_with_cohrs_and_clumpdensity.fits')
...
#plt.subplot(221)
plt.loglog(totalmass.data, clumpmass.data, 'ro', label = None) #x Vs. y
...
plt.ylabel(r'Clump Mass, $M_\odot$')
